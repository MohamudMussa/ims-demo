...
public class CustomerTest {
	...
	@Before
	public void setUp() {
		customer = new Customer(1L, "Chris", "Perrins", "46 happy road");
		other = new Customer(1L, "Chris", "Perrins", "46 happy road");
	}
	...
	public void toStringTest() {
		String toString = "Customer [id=1, firstName=Chris, surname=Perrins, address=46 happy road]";
